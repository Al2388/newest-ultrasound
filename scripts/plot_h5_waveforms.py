...
Usage
-----
  python plot_h5_waveforms.py data/raw/ascan/ascan_1778240169.h5
  python plot_h5_waveforms.py data/raw/ascan/ascan_new.h5 --dataset raw_waveforms
  python plot_h5_waveforms.py data/raw/ascan/ascan_new.h5 --out-dir plots --max-traces 80

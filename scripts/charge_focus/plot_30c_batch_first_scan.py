"""Render the very first scan of the 30C batch (r001) -- 3 modalities side by side.

Same style as the 25C / 35C r001 plots.
"""
...
R001_SESSION = PROJ / "data/raw/cscan/cscan_longrun_cycling_30c_2026-05-31_22-23-14_r001_2026-05-31_22-23-14"
ROI_MASK_PATH = PROJ / "reports/experiments/roi_clean_figs_2026-05-29_18-29-16_50x40_grayamp/roi_mask.npy"
OUT_DIR = PROJ / "reports/longrun_cycling_30c_2026-05-31_22-23-14_analysis"
OUT = OUT_DIR / "batch_r001_first_scan.png"
...
def main():
    ...
    fig.suptitle(
        f"30°C cycling batch -- FIRST scan (r001)\n"
        f"{R001_SESSION.name}\n"

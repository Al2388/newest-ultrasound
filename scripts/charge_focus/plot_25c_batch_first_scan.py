"""Render the very first scan of the 25C batch (r001) -- 3 modalities side by side.

Same style as plot_35c_batch_first_scan.py, for direct visual comparison
of cell starting state at the two campaign temperatures.
"""
...
R001_SESSION = PROJ / "data/raw/cscan/cscan_longrun_cycling_3p238start_2026-05-29_18-54-23_r001_2026-05-29_18-54-23"
ROI_MASK_PATH = PROJ / "reports/experiments/roi_clean_figs_2026-05-29_18-29-16_50x40_grayamp/roi_mask.npy"
OUT = PROJ / "reports/longrun_cycling_22h_charge_focus/batch_r001_first_scan.png"
...
def main():
    ...
    fig.suptitle(
        f"25°C cycling batch -- FIRST scan (r001)\n"
        f"{R001_SESSION.name}\n"
